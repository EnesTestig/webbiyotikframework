...
if (!function_exists('error_handler'))
{
    ...
    {
        Framework\Exceptions\Handler::report($code, $msg, $file, $line);
    }
}
...
if (!function_exists('exception_handler'))
{
    ...
    {
        Framework\Exceptions\Handler::report($e->getCode(), $e->getMessage(), $e->getFile(), $e->getLine());
    }
}
...
if (!function_exists('shutdown_handler'))
{
    ...
    function shutdown_handler()
    {
        ...
        {
            Framework\Exceptions\Handler::report($e['type'], $e['message'], $e['file'], $e['line']);
        }
    }
}
...
if (!function_exists('pagination'))
{
    ...
    {
        return Framework\Helpers\Pagination::getContent($pages, $active, $url);
    }
}
...
if (!function_exists('get_theme_config'))
{
    ...
    function get_theme_config(String $key)
    {
        if (file_exists(THEME_DIR.'customize.json')) {
            ...
            /* Json decode */
            $config = \Framework\Helpers\Json::decodeArray($config);
